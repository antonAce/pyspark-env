...
def dialog_lag(df: DataFrame, input_col: str, output_col: str, partition_col: str = None) -> DataFrame:
    ...
    window = Window.partitionBy(partition_col).orderBy("id") if partition_col is not None else Window.orderBy("id")
